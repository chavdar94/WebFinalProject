...
urlpatterns = [
    ...
    path('post/<str:slug>/', include([
        ...
        path('comment/<int:pk>/edit/', post_views.CommentEditView.as_view(), name='comment_edit'),
        path('comment/<int:pk>/delete/', post_views.CommentDeleteView.as_view(), name='comment_delete'),
    ])),
]
